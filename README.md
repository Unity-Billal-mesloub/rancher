...
<!-- stable v2.14.2 DO NOT REMOVE THIS LINE -->
* v2.14.2 - `rancher/rancher:v2.14.2` / `rancher/rancher:stable` - Read the full release [notes](https://github.com/Unity-Billal-mesloub/rancher/releases/tag/v2.14.2).
